...
READ IN THIS ORDER — do this before doing anything else
  ...
  OPEN-DECISIONS.md open items — resolve these WITH ME before Phase 0
...
ALREADY DECIDED — don't relitigate these
  ...
  Install root: UNRESOLVED — see OPEN-DECISIONS.md OD-1 (D: vs E:)
...
OPEN-DECISIONS.md lists seven unresolved items. Three of them (OD-1 install
root, OD-2 module root, OD-5 install permission) block Phase 0. Raise them,
don't guess at them.
