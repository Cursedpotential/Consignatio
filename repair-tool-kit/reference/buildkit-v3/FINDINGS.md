...
**Scope caveat:** run in a Linux sandbox on 2026-09-11, not with the Windows
binaries casekit will ship. Phase 0 re-runs it against the pinned poppler.
The finding is about *poppler the implementation*; confirm it holds for *the
poppler binary in the install root*.
