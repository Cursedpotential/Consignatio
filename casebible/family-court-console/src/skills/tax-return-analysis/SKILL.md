---
name: fct-tax-return-analysis
description: "(family-court-toolkit) Produces litigation-ready financial memoranda from multi-year tax returns, covering income trends, filing status changes, deduction patterns, red flags, and trustee considerations. Use when reviewing Form 1040s for bankruptcy means testing, family law support calculations, personal injury damages, or financial discovery analysis."
---
> _Byline: Claude Code · Fable 5.1 · 2026-09-07 — restored as a first-class skill (was `references/tax-return-analysis` under the `family-court-toolkit` entry skill; owner ruling 15:23)._
# Tax Return Analysis
