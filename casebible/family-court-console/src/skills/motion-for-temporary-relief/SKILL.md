---
name: fct-motion-for-temporary-relief
description: "(family-court-toolkit) Drafts a Motion for Temporary Relief (Pendente Lite) in U.S. family law cases seeking interim orders for custody, support, property use, and fees. Use when filing for temporary orders at the outset of a dissolution, separation, or custody matter to stabilize rights and obligations during pendency."
---
> _Byline: Claude Code · Fable 5.1 · 2026-09-07 — restored as a first-class skill (was `references/motion-for-temporary-relief` under the `family-court-toolkit` entry skill; owner ruling 15:23)._
## Michigan authority (added 2026-09-07 — PROVISIONAL, verify current text)

For a Michigan / Genesee County matter, replace this generic member's "pendente lite" framing and
filing mechanics with Michigan's own rules:

- **Interim / ex parte orders:** MCR 3.207. `[VERIFY]` current text against the archived compilation
  before citing a specific subrule — governs temporary orders pending a domestic relations action,
  including ex parte relief.
- **Motion practice:** MCR 2.119. `[VERIFY]` current text — governs motion form, filing/service
  timing (the 9-day mail-service / 7-day filing distinction), and concurrence requirements; see also
  the Genesee-specific concurrence-certificate and proposed-order requirements under Genesee LCR
  2.119(A)–(B) (cross-reference `custody_guide_outline_v2.md` Module 4.3/4.4 — do not restate the
  local rule text here from memory).
- **Underlying custody/support standard:** MCL 722.27. `[VERIFY]` current text; cross-reference
  `custody_guide_outline_v2.md` Module 2 for the verbatim best-interest factors this motion's
  custody-related relief must be framed against.

Do not invent a pin cite this member cannot see in the archived MCR text; mark anything unconfirmed
`[VERIFY]` rather than stating it as settled.
...
> _Amended: Claude Code · Fable 5.1 · 2026-09-07 — added Michigan authority block (MCR 3.207, MCR 2.119, MCL 722.27)._
