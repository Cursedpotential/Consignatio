...
metadata:
  ...
  - Drafting
---
> _Byline: Claude Code · Fable 5.1 · 2026-09-07 — restored as a first-class skill (was `references/dvro-petition` under the `family-court-toolkit` entry skill; owner ruling 15:23)._
## Michigan authority (added 2026-09-07 — PROVISIONAL, verify current text)

For a Michigan / Genesee County matter, this generic drafting member's out-of-state assumptions must
be replaced with:

- **Controlling statute:** MCL 600.2950 (domestic relationship PPO) / MCL 600.2950a (non-domestic
  stalking/sexual-assault PPO). `[VERIFY]` current text — not archived in `sources/primary/` as of
  this amendment; confirm against legislature.mi.gov before citing a subsection.
- **Court rules:** MCR 3.703–3.707 (personal protection order proceedings). `[VERIFY]` current text
  against the archived compilation before citing a specific subrule.
- **SCAO forms (Michigan uses SCAO forms, not the California/Nevada/Texas form numbers this member
  was originally written against):** **CC 375** (Petition for Personal Protection Order), **CC 376**
  (Ex Parte Personal Protection Order), **CC 379** (Personal Protection Order after hearing).
  `[VERIFY]` current form numbers/revisions at the official SCAO forms page before filing — form
  numbers and revision dates drift.
- **Archived primary text:** `content/custody-guide/sources/primary/mji-domestic-violence-benchbook.md`
  (MJI Domestic Violence Benchbook) — use this archive, not parametric memory, for any DV doctrine
  this member needs (e.g., firearms relinquishment, tracking-device provisions).

Do not invent a pin cite this member cannot see in the archived benchbook or an MCR/MCL text; mark
anything unconfirmed `[VERIFY]` rather than stating it as settled.
...
| Required forms | ~~Judicial Council / court-specific form set (e.g., DV-100, DV-109, DV-110, CLETS-001)~~ **For Michigan: SCAO forms CC 375/CC 376/CC 379 — see "Michigan authority" above; `[VERIFY]` current numbers/revisions before filing. Other jurisdictions: confirm that jurisdiction's own form set.** |
...
- [ ] Required court forms — Michigan: SCAO forms CC 375/CC 376/CC 379 (see "Michigan authority" above); other jurisdictions: that jurisdiction's own form set [VERIFY form numbers]
...
> _Amended: Claude Code · Fable 5.1 · 2026-09-07 — added Michigan authority block; replaced California-illustrative form numbers with Michigan SCAO form references._
