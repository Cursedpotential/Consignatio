---
name: fct-trusted-sources
description: "(family-court-toolkit) Acquire authoritative reference documents — statutes, regulations, official policies, terms of service, agency guidance — into the case folder with provenance and plaintext extraction. Triggers when the user names a specific law/regulation/policy/ToS the case will cite, asks 'do we have a copy of <X>' or 'where do I find the official text of <Y>', supplies a copy and asks 'can we use this', or when packet-builder needs a reference appendix that isn't on disk."
---
> _Byline: Claude Code · Fable 5.1 · 2026-09-07 — restored as a first-class skill (was `references/trusted-sources` under the `family-court-toolkit` entry skill; owner ruling 15:23)._
# trusted-sources
